"""
012_Ramsey_ef - Ramsey Experiment for ef state

This experiment is used to perform ramsey (T2) experiment for a single qubit ef state.
The timing parameter sweep is done using a QickParam object.
