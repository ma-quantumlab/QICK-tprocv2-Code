"""
007_SpinEcho_ge - Spin Echo Experiment for ge state

This experiment is used to perform a spin echo (T2*) experiment for a single
qubit. The timing parameter sweep is done using a QickParam object.
